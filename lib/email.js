...
const FROM = process.env.EMAIL_FROM || 'Dragonfruit Ventures <bookings@dfruitventures.com>';
...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#09090B;color:#FAFAFA;margin:0;padding:0;">
  <div style="max-width:600px;margin:0 auto;padding:48px 24px;">
    <img src="${BASE_URL}/logo.png" alt="Dragonfruit Ventures" style="height:36px;margin-bottom:40px;" />
